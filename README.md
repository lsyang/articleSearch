...
* [x] List anything else that you can get done to improve the app functionality!
       - added better styling for readablility: grey background on each article. Appropriate padding/margin
       - hide image when there's no image to display

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://media.giphy.com/media/3og0IBu8PwEJRcrFAs/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
